...
<html lang="en">
  ...
  <body>
	...
	<h1>Edit User</h1>
	  ...
	  <br/>  <br/>
<form class="form-horizontal" action="<?php echo site_url('admin/users/edit/'.$user['id']);?>" method="POST" enctype="multipart/form-data" >
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="password" id="password" name="password"  value="<?php echo $user['password'];?>" ></div>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="midname" name="midname"  value="<?php echo $user['mid_name'];?>">
    </div>
  </div>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="website" name="website" value="<?php echo $user['website'];?>" >
    </div>
  </div>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="file" id="picture" name="picture" value="<?php echo $user['picture'];?>" >
    </div>
  </div>
